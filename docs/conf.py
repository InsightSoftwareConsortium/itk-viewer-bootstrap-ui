...
htmlhelp_basename = 'itk-viewer-bootstrap-uidoc'
...
man_pages = [
    (master_doc, 'itk-viewer-bootstrap-ui', 'itk-viewer-bootstrap-ui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'itk-viewer-bootstrap-ui', 'itk-viewer-bootstrap-ui Documentation',
     author, 'itk-viewer-bootstrap-ui', 'One line description of project.',
     'Miscellaneous'),
]
