      ...
      {planes.map((plane, idx) => {
        return state.context.main[`${plane}Slice`] ? (
          ...
          >
            ...
            {/*---- END - Plane visibility button ------*/}
            {/*---- BEGIN - Play slide button ------*/}
            <Tooltip
              ref={scrollRefs[idx]}
            ...
            {/*---- END - Play slide button ------*/}
            {/* --- BEGIN - Add scaling by the slide bars --- */}
            <Chip
              className="sliderIcons"
              size="small"
              ...
              color="secondary"
            />
            {/* --- END: Add scaling by the slide bars --- */}
            {/* --- BEGIN: Actual slide bars --- */}
            <Slider
